...
export function GreetWidget() {
  ...
  return (
    <div className="font-sans p-4">
      <div className="rounded-xl shadow-sm p-4 bg-white dark:bg-gray-800">
        <div className="mb-3">
          <h3 className="text-gray-900 dark:text-gray-100">Greet from a react component</h3>
        </div>
        <div className="flex gap-2 items-center">
          <input
            ...
            className="flex-1 px-2.5 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
          />
          <button
            onClick={handleGreet}
            disabled={isLoading}
            className="px-3 py-2 border-none bg-gray-900 dark:bg-gray-700 text-white dark:text-gray-100 rounded-lg cursor-pointer disabled:cursor-default disabled:opacity-60 hover:bg-gray-800 dark:hover:bg-gray-600"
          >
            Greet
          </button>
        </div>
        {greeting && (
          <div className="mt-3 text-gray-900 dark:text-gray-100 font-medium">
            {greeting}
          </div>
        )}
